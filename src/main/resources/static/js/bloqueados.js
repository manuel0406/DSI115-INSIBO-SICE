...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var confirmAcceptModal = new bootstrap.Modal(
    document.getElementById("confirmInLockModal")
  );
...
document.querySelectorAll(".btn-desbloqueo-inactivo").forEach(function (element) {
  element.addEventListener("click", function () {
    Swal.fire({
      position: "center",
      icon: "error",
      title: "Oops",
      text: "Este usuario no puede ser desbloqueado, informar a soporte.",
