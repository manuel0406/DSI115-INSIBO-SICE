...
document.addEventListener("DOMContentLoaded", function() {
  var blockButtons = document.querySelectorAll('.btn-block');
  var confirmDeleteModal = new bootstrap.Modal(document.getElementById('confirmBlockModal'));
  var confirmDeleteButton = document.getElementById('confirmBlockButton');
  var modalBody = document.querySelector('.body-modal-block');
  var currentHref = '';
...
blockButtons.forEach(function(button) {
      button.addEventListener('click', function(event) {
          ...
          modalBody.textContent = "¿Deseas bloquear al usuario " + correo + "?";
